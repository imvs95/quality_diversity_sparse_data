...
def run_sim_model(sol, df_truemodel, dec_var, lock):
    ...
    The behavior space of this function is the detection probability of parcels and the transport cost."""
    ...
    behaviour_space_sol = [kpis_simmodel["Detection_Prob_Parcels"], kpis_simmodel["Transport_Cost"]]
