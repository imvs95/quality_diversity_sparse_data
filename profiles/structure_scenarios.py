...
if __name__ == '__main__':
    ...
    folder_name = start_date + f"_QD_{scen}_CMAES_Structure"
    ...
    seeds = [5, 10, 15, 20]
    with mp.Pool(processes=25) as pool:  # mp.cpu_count() #, maxtasksperchild=1
        for s in seeds:
            ...
            print(datetime.now().strftime("%d/%m/%Y %H:%M:%S"), f" Start optimization for CMA ES with seed {s}")
