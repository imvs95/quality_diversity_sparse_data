...
if __name__ == '__main__':
    ...
    #For Ground Truth
    with open(r"../../complex_stylized_supply_chain_model_generator/data/"
              r"Ground_Truth_Graph_Topology_DF_CNHK_USA.pkl", "rb") as file:
        df_ground_truth = pickle.load(file)
        dec_var = df_ground_truth.to_dict(orient="index")
    ...
    folder_name = start_date + "_QD_0_MAP_MO"
    ...
    with mp.Pool(processes=1) as pool:  # mp.cpu_count()
        for itr in range(n_iterations):
            ...
            solutions = reformat_solution_for_sim_map(solutions, new_bounds)
